<div class="p-6">
                ...
                @foreach($data as $item)
                    <tr>
                        <td class="px-6 py-4 text-sm whitespace-no-wrap">
                            {{ $item->title }}
                            {!! $item->is_default_home? '<span class="text-green-400 text-sm font-bold">[Default Home Page ]</span>':''!!}
                            {!! $item->is_default_not_found? '<span class="text-red-600 text-sm font-bold">[Default 404 Page ]</span>':''!!}
                        </td>
                        <td class="px-6 py-4 text-sm whitespace-no-wrap">
                            <a
    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <label>
                    <input class="form-checkbox" value="{{ $isSetToDefaultHomePage }}" type="checkbox" wire:model="isSetToDefaultHomePage">
                    <span class="ml-2 text-sm text-gray-600"> Imposta come home page predefinita</span>
                </label>
            </div>
            <div class="mt-4">
                <label>
                    <input value="{{ $isSetToDefaulNotFoundPage }}" type="checkbox" wire:model="isSetToDefaulNotFoundPage">
                    <span class="ml-2 text-sm text-red-600"> Imposta come pagina 404 errore predefinita</span>
                </label>
            </div>
